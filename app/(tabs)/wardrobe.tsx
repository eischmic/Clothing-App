    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: base.canvas }} edges={['top']}>
      <ScrollView contentContainerStyle={{ padding: spacing.md, paddingBottom: spacing.xxl }}>
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end' }}>
          <View>
            <Text style={[type.display, { color: base.textHi }]}>Wardrobe</Text>
            <Text style={[type.body, { color: base.textMid }]}>{wardrobeItems.length} pieces</Text>
          </View>
          <Text
        ...
        {wardrobeItems.length === 0 ? (
          ...
          <>
            ...
            <View style={{ height: 12, borderRadius: 6, overflow: 'hidden', flexDirection: 'row', backgroundColor: base.hairline }}>
            ...
            <View style={{ flexDirection: 'row', gap: spacing.xs }}>
              {FORMALITY_LABELS.map((label, index) => {
                ...
                return (
                  ...
                  >
                    <Text style={[type.caption, { color: active ? accent.bright : base.textLow, textAlign: 'center' }]}>
                      {label}
                    </Text>
                  </View>
                );
